    ...
    <section id="systems" className="py-16 px-6 max-w-6xl mx-auto">
      <div className="fade-in glass rounded-2xl p-7 md:p-10 flex flex-col md:flex-row gap-8 items-start">
        <div className="md:w-1/2">
          <p className="text-xs font-mono text-[#00d2ff] tracking-widest uppercase mb-3">Systems & Low-Level</p>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-xs text-[#00d2ff] border border-[#00d2ff]/25 px-3 py-1.5 rounded-lg hover:bg-[#00d2ff]/05 transition-colors font-mono"
          >
